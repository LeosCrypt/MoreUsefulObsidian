...
public class ObsiGemItem extends MoreUsefulObsidianModElements.ModElement {
	@ObjectHolder("more_useful_obsidian:obsi_gem")
	public static final Item block = null;
	public ObsiGemItem(MoreUsefulObsidianModElements instance) {
		super(instance, 41);
	}
