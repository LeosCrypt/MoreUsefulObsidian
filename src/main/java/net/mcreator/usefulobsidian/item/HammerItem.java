...
public class HammerItem extends MoreUsefulObsidianModElements.ModElement {
	@ObjectHolder("more_useful_obsidian:hammer")
	public static final Item block = null;
	public HammerItem(MoreUsefulObsidianModElements instance) {
		super(instance, 69);
	}
