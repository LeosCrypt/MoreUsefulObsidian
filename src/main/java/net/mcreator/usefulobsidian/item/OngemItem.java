...
public class OngemItem extends MoreUsefulObsidianModElements.ModElement {
	@ObjectHolder("more_useful_obsidian:ongem")
	public static final Item block = null;
	public OngemItem(MoreUsefulObsidianModElements instance) {
		super(instance, 54);
	}
