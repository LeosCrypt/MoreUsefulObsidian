...
public class ObsidianplateItem extends MoreUsefulObsidianModElements.ModElement {
	@ObjectHolder("more_useful_obsidian:obsidianplate")
	public static final Item block = null;
	public ObsidianplateItem(MoreUsefulObsidianModElements instance) {
		super(instance, 31);
	}
